...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 70B8D60EB87
	for <lists+linux-spi@lfdr.de>; Thu, 27 Oct 2022 00:23:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233308AbiJZWX1 (ORCPT <rfc822;lists+linux-spi@lfdr.de>);
        Wed, 26 Oct 2022 18:23:27 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46288 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229551AbiJZWXZ (ORCPT
        <rfc822;linux-spi@vger.kernel.org>); Wed, 26 Oct 2022 18:23:25 -0400
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C0413CF184
        for <linux-spi@vger.kernel.org>; Wed, 26 Oct 2022 15:23:21 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1666823001; x=1698359001;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=Gz5f2LolIoQrW7bt9/GgJX368vuUo44XlQbWUYXzCag=;
  b=klzkCvSx3DG0ZxtOxzK7RJ1HvLwn8y/NPwOro/+SLtKrYMq/HE3jrmkN
   IjZeElRpmjx2JKRVsKRJUwk8SNEWR3XK7aIWqD9V52Bs+mskOCZDnWJHQ
   LfKW3nsI3m/hLbe+j4WcEjMDymsp4v5qXuI8xRgRNv7ukzIcYxzAqlISc
   UMWam2UqvhBbeOHl35jXnOEbXqOFoS+YYkRhBiHN28s1ba5SsqEXHCbrZ
   fBXkftILHO4TrzwL3kgeo+lNoCSPzuFJAPuFvQegQa00ANjjZKPv/m65d
   i6YDc59fD+CeOT0iwPHhOT9BeZVR7TTMXX14KubsMtDIIcHqoTK7LFST0
   Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10512"; a="334698483"
X-IronPort-AV: E=Sophos;i="5.95,215,1661842800"; 
   d="scan'208";a="334698483"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 26 Oct 2022 15:23:21 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10512"; a="663382140"
X-IronPort-AV: E=Sophos;i="5.95,215,1661842800"; 
   d="scan'208";a="663382140"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
  by orsmga008.jf.intel.com with ESMTP; 26 Oct 2022 15:23:18 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1ononu-0007v2-0P;
        Wed, 26 Oct 2022 22:23:18 +0000
Date:   Thu, 27 Oct 2022 06:23:12 +0800
From:   kernel test robot <lkp@intel.com>
To:     Neil Armstrong <neil.armstrong@linaro.org>
Cc:     oe-kbuild-all@lists.linux.dev, linux-spi@vger.kernel.org,
        Mark Brown <broonie@kernel.org>
Subject: [broonie-spi:for-linus 40/41] arch/arm/include/asm/div64.h:51:36:
 error: passing argument 1 of '__div64_32' from incompatible pointer type
Message-ID: <202210270656.OSw862JI-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="0F+Uq7Lx3jx9zg7b"
...
tree:   https://git.kernel.org/pub/scm/linux/kernel/git/broonie/spi.git for-linus
head:   574f97ab96d6b153407161746bc127564e998b4f
commit: 04694e50020b62b10bd0d46ff9e9708a6e1c7eb3 [40/41] spi: meson-spicc: move wait completion in driver to take bursts delay in account
config: arm-randconfig-r003-20221026
compiler: arm-linux-gnueabi-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://git.kernel.org/pub/scm/linux/kernel/git/broonie/spi.git/commit/?id=04694e50020b62b10bd0d46ff9e9708a6e1c7eb3
        git remote add broonie-spi https://git.kernel.org/pub/scm/linux/kernel/git/broonie/spi.git
        git fetch --no-tags broonie-spi for-linus
        git checkout 04694e50020b62b10bd0d46ff9e9708a6e1c7eb3
...
>> arch/arm/include/asm/div64.h:51:36: error: passing argument 1 of '__div64_32' from incompatible pointer type [-Werror=incompatible-pointer-types]
      51 | #define do_div(n, base) __div64_32(&(n), base)
         ...
         |                                    |
         |                                    long unsigned int *
   drivers/spi/spi-meson-spicc.c:420:9: note: in expansion of macro 'do_div'
