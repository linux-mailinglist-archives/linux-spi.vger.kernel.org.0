...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C125D2B803C
	for <lists+linux-spi@lfdr.de>; Wed, 18 Nov 2020 16:16:34 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727301AbgKRPQP (ORCPT <rfc822;lists+linux-spi@lfdr.de>);
        Wed, 18 Nov 2020 10:16:15 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46222 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726336AbgKRPQO (ORCPT
        <rfc822;linux-spi@vger.kernel.org>); Wed, 18 Nov 2020 10:16:14 -0500
Received: from mail-lf1-x133.google.com (mail-lf1-x133.google.com [IPv6:2a00:1450:4864:20::133])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 41A44C0613D4
        for <linux-spi@vger.kernel.org>; Wed, 18 Nov 2020 07:16:14 -0800 (PST)
Received: by mail-lf1-x133.google.com with SMTP id z21so3405984lfe.12
        for <linux-spi@vger.kernel.org>; Wed, 18 Nov 2020 07:16:14 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=date:from:to:cc:subject:message-id:references:mime-version
         :content-disposition:content-transfer-encoding:in-reply-to;
        bh=+KF0idnF9D0pcr461pfy7sAcSz+KmTpYT5Bm2D5QxW4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:date:from:to:cc:subject:message-id:references
         ...
         :in-reply-to;
        bh=+KF0idnF9D0pcr461pfy7sAcSz+KmTpYT5Bm2D5QxW4=;
        b=
X-Gm-Message-State: AOAM533HMCjG9F5rNyi67560+0Fxgoh4nUIHfZaGs/ZJfzqQlJ3ZAJK2
        9AOPxBeMElpJfcc2mo84OfU=
X-Google-Smtp-Source: ABdhPJypqlsdZFNJdfHiKV9OU69mkEgznkXLEU35dAFzlSyDhC30L4YTtmf9GszvikIyDzxH23IWvw==
X-Received: by 2002:ac2:44ac:: with SMTP id c12mr4229184lfm.602.1605712572482;
        Wed, 18 Nov 2020 07:16:12 -0800 (PST)
Received: from mobilestation ([95.79.141.114])
        by smtp.gmail.com with ESMTPSA id f1sm3437812ljp.65.2020.11.18.07.16.10
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 18 Nov 2020 07:16:11 -0800 (PST)
Date:   Wed, 18 Nov 2020 18:16:09 +0300
...
Message-ID: <20201118151609.4bfvuoe6s6no5tcd@mobilestation>
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="snagsyzdwzxl3pe6"
...
Content-Disposition: attachment; filename="check_mismatch.sh"
Content-Transfer-Encoding: quoted-printable

#!/bin/sh=0A=0ADEPTH=3D${1:?"FIFO depth is missing"}=0ABASE=3D${2:?"Pass DW=
 APB SSI registers address"}=0ACTRLR0=3D$((BASE))=0ACTRLR1=3D$((BASE + 0x04=
))=0ASSIENR=3D$((BASE + 0x08))=0ASER=3D$((BASE + 0x10))=0ABAUDR=3D$((BASE +=
 0x14))=0ATXFTLR=3D$((BASE + 0x18))=0ARXFTLR=3D$((BASE + 0x1c))=0ATXFLR=3D$=
((BASE + 0x20))=0ARXFLR=3D$((BASE + 0x24))=0ASR=3D$((BASE + 0x28))=0AIMR=3D=
$((BASE + 0x2c))=0AISR=3D$((BASE + 0x30))=0ARISR=3D$((BASE + 0x34))=0AICR=
=3D$((BASE + 0x48))=0ADR=3D$((BASE + 0x60))=0A=0A# Make sure devmem is foun=
d in the system=0Awhich devmem 2>1 >/dev/null=0A[ $? -ne 0 ] && printf "No =
devmem found\n" && exit 1=0A=0A# Disable the controller=0Adevmem $SSIENR 32=
 0x0=0A# Setup a default mode: TMOD=3D0x0, FRF=3D0x0, DFS=3D0x7=0Adevmem $C=
TRLR0 32 0x7=0Adevmem $CTRLR1 32 0x0=0A# Disable all chip-selects=0Adevmem =
$SER 32 0x0=0A# Set the maximum baud-rate just to activate the xfer=0Adevme=
m $BAUDR 32 0x2=0A# Mask all interrupts to prevent the driver from being bo=
thered=0Adevmem $IMR 32 0xff=0A# Clear interrupts if any is pending=0Adevme=
m $ICR 32 > /dev/null=0A=0A# Print the controller state before doing anythi=
ng=0Aprintf "1. Tx FIFO lvl %u, Rx FIFO lvl %u, RISR 0x%08x\n" \=0A	"$(devm=
em $TXFLR 32)" "$(devmem $RXFLR 32)" "$(devmem $RISR 32)"=0A=0A# Enable the=
 controller and fill the Tx FIFO in with 0xFFs=0Adevmem $SSIENR 32 0x1=0AID=
X=3D0; while [ $IDX -lt $DEPTH ]; do=0A	devmem $DR 32 0xff=0A	IDX=3D$((IDX =
+ 1))=0Adone=0A=0A# Print the controller state after it=0Aprintf "1. Tx FIF=
O lvl %u, Rx FIFO lvl %u, RISR 0x%08x\n" \=0A	"$(devmem $TXFLR 32)" "$(devm=
em $RXFLR 32)" "$(devmem $RISR 32)"=0A=0A# Enable communications by activat=
ing the very first CS=0Adevmem $SER 32 0x1=0A=0A# Let the data being transf=
ered and print the state after it=0Asleep 1=0Aprintf "2. Tx FIFO lvl %u, Rx=
 FIFO lvl %u, RISR 0x%08x\n" \=0A	"$(devmem $TXFLR 32)" "$(devmem $RXFLR 32=
)" "$(devmem $RISR 32)"=0A
--snagsyzdwzxl3pe6--
