...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id EB78C455C45
	for <lists+linux-spi@lfdr.de>; Thu, 18 Nov 2021 14:07:12 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230002AbhKRNJY (ORCPT <rfc822;lists+linux-spi@lfdr.de>);
        Thu, 18 Nov 2021 08:09:24 -0500
Received: from mga09.intel.com ([134.134.136.24]:54399 "EHLO mga09.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S234233AbhKRNJE (ORCPT <rfc822;linux-spi@vger.kernel.org>);
        Thu, 18 Nov 2021 08:09:04 -0500
X-IronPort-AV: E=McAfee;i="6200,9189,10171"; a="234011720"
X-IronPort-AV: E=Sophos;i="5.87,244,1631602800"; 
   d="scan'208";a="234011720"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 18 Nov 2021 05:05:45 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.87,244,1631602800"; 
   d="scan'208";a="736910560"
Received: from black.fi.intel.com ([10.237.72.28])
  by fmsmga005.fm.intel.com with ESMTP; 18 Nov 2021 05:05:40 -0800
Received: by black.fi.intel.com (Postfix, from userid 1001)
        id 0A648557; Thu, 18 Nov 2021 15:05:44 +0200 (EET)
...
Subject: [PATCH v4 2/3] mtd: spi-nor: intel-spi: Convert to SPI MEM
Date:   Thu, 18 Nov 2021 16:05:42 +0300
Message-Id: <20211118130543.11179-3-mika.westerberg@linux.intel.com>
...
---
 ...
 .../intel-spi.c => spi/spi-intel.c}           | 808 ++++++++++++------
 drivers/spi/spi-intel.h                       |  19 +
 include/linux/mfd/lpc_ich.h                   |   2 +-
 .../x86/{intel-spi.h => spi-intel.h}          |   6 +-
 11 files changed, 610 insertions(+), 368 deletions(-)
...
index f35597cbea0c..183015ce77ca 100644
...
+		writel(addr, ispi->base + FADDR);
 		...
 		val = readl(ispi->base + HSFSTS_CTL);
 		val &= ~(HSFSTS_CTL_FDBC_MASK | HSFSTS_CTL_FCYCLE_MASK);
@@ -752,79 +625,472 @@ static ssize_t intel_spi_write(struct spi_nor *nor, loff_t to, size_t len,
 			ret = -EACCES;
...
@@ -896,70 +1162,74 @@ static void intel_spi_fill_partition(struct intel_spi *ispi,
 	}
 }
