...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 09EDD4C2038
	for <lists+linux-spi@lfdr.de>; Thu, 24 Feb 2022 00:47:04 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236558AbiBWXra (ORCPT <rfc822;lists+linux-spi@lfdr.de>);
        Wed, 23 Feb 2022 18:47:30 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42148 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230499AbiBWXr3 (ORCPT
        <rfc822;linux-spi@vger.kernel.org>); Wed, 23 Feb 2022 18:47:29 -0500
Received: from phobos.denx.de (phobos.denx.de [IPv6:2a01:238:438b:c500:173d:9f52:ddab:ee01])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9EB695A08E
        for <linux-spi@vger.kernel.org>; Wed, 23 Feb 2022 15:46:59 -0800 (PST)
Received: from [127.0.0.1] (p578adb1c.dip0.t-ipconnect.de [87.138.219.28])
        (using TLSv1.3 with cipher TLS_AES_128_GCM_SHA256 (128/128 bits))
        (No client certificate requested)
        (Authenticated sender: marex@denx.de)
        by phobos.denx.de (Postfix) with ESMTPSA id D899383B76;
        Thu, 24 Feb 2022 00:46:56 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=denx.de;
        s=phobos-20191101; t=1645660017;
        bh=TJv1vcuqvytQ6jBOGsau1KT0RbQBxdKjEbEUxz7Fri4=;
        h=Date:Subject:To:Cc:References:From:In-Reply-To:From;
        b=
Message-ID: <d6ef996d-6a0c-1ebb-dc18-3777c4aba25b@denx.de>
Date:   Thu, 24 Feb 2022 00:46:56 +0100
MIME-Version: 1.0
...
References: <20220221043238.295369-1-marex@denx.de>
 ...
 <3e9721ff-ba1d-c02b-09da-f3334b1df409@kernel.org>
From:   Marek Vasut <marex@denx.de>
In-Reply-To: <3e9721ff-ba1d-c02b-09da-f3334b1df409@kernel.org>
...
On 2/23/22 23:18, Dinh Nguyen wrote:
> 
> 
...
>>>>>>>>>>
>>>>>>>>>> Is this DAC really not working on socfpga gen5 or is there 
>>>>>>>>>> some other issue ?
>>>>>>>>>
>>>>>>>>> I don't know the answer to this question. What is the DAC in 
>>>>>>>>> the QSPI module and how do I go about testing it?
>>>>>>>>
>>>>>>>> DAC = direct access.
>>>>>>>>
...
>> Thank you
>>
>> If you cannot reproduce it there, drop this patch and I'll revisit 
>> this on my side.
> 
...
This looks like something else and it doesn't even come from the CQSPI, 
maybe it is some temporary issue that's already fixed in the upcoming next.
