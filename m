...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id A1AF5F6F0B
	for <lists+linux-spi@lfdr.de>; Mon, 11 Nov 2019 08:32:10 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726785AbfKKHcJ (ORCPT <rfc822;lists+linux-spi@lfdr.de>);
        Mon, 11 Nov 2019 02:32:09 -0500
Received: from mga12.intel.com ([192.55.52.136]:65156 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726770AbfKKHcJ (ORCPT <rfc822;linux-spi@vger.kernel.org>);
        Mon, 11 Nov 2019 02:32:09 -0500
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by fmsmga106.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 10 Nov 2019 23:32:04 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.68,291,1569308400"; 
   d="scan'208";a="206658074"
Received: from linux.intel.com ([10.54.29.200])
  by orsmga003.jf.intel.com with ESMTP; 10 Nov 2019 23:32:04 -0800
Received: from [10.226.38.147] (unknown [10.226.38.147])
        by linux.intel.com (Postfix) with ESMTP id 0E43F5803A5;
        Sun, 10 Nov 2019 23:32:01 -0800 (PST)
...
References: <20191030081155.29947-1-vadivel.muruganx.ramuthevar@linux.intel.com>
 ...
 <1f0e56c4-6a09-da05-204d-f1856fcbe8f8@ti.com>
From:   "Ramuthevar, Vadivel MuruganX" 
        <vadivel.muruganx.ramuthevar@linux.intel.com>
Message-ID: <64fc59c3-e118-f944-dff5-57cb8dcaa4e8@linux.intel.com>
Date:   Mon, 11 Nov 2019 15:32:00 +0800
User-Agent: Mozilla/5.0 (Windows NT 10.0; WOW64; rv:60.0) Gecko/20100101
 Thunderbird/60.9.0
MIME-Version: 1.0
In-Reply-To: <1f0e56c4-6a09-da05-204d-f1856fcbe8f8@ti.com>
...
Hi Vignesh,
 ...
    Thanks for review comments, sorry for the late reply since I was in 
one week vacation.

On 7/11/2019 1:44 PM, Vignesh Raghavendra wrote:
>
...
sure,  will fix it next patch-set.
>> +	u32 reg;
>> +
...
surely we will keep the polling routines and also as per your suggestion 
later will add the performance related patches.

To reduce the code size, removed the comments, will keep it.
...
On our board, this needs dummy clocks to work spi-nand, will 
differentiate and add in the init part instead of

cqspi_indirect_read_setup.
...
> is 4.
Agreed!, add it in the next patch.
>
>> +	/* Configure the quad */
...
sure, will take care flash type specific handling.
>> +		break;
>> +	case 3:
>> +		cmd_ops = &ops[0];
>> +		addr_ops = &ops[1];
...
Thanks for the suggestion, i will update in the next patch-set.
...
driver works perfectly on our platform, since we do not have DMA , just 
left the code.

I will add those part of code in the next series of patch.
