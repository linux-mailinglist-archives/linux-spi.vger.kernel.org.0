...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8E5174251E2
	for <lists+linux-spi@lfdr.de>; Thu,  7 Oct 2021 13:21:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232729AbhJGLXZ (ORCPT <rfc822;lists+linux-spi@lfdr.de>);
        Thu, 7 Oct 2021 07:23:25 -0400
Received: from mga06.intel.com ([134.134.136.31]:22388 "EHLO mga06.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S240278AbhJGLXY (ORCPT <rfc822;linux-spi@vger.kernel.org>);
        Thu, 7 Oct 2021 07:23:24 -0400
X-IronPort-AV: E=McAfee;i="6200,9189,10129"; a="287108353"
X-IronPort-AV: E=Sophos;i="5.85,354,1624345200"; 
   d="scan'208";a="287108353"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 07 Oct 2021 04:21:30 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.85,354,1624345200"; 
   d="scan'208";a="522567170"
Received: from black.fi.intel.com ([10.237.72.28])
  by orsmga001.jf.intel.com with ESMTP; 07 Oct 2021 04:21:26 -0700
Received: by black.fi.intel.com (Postfix, from userid 1001)
        id 034711C8; Thu,  7 Oct 2021 14:21:32 +0300 (EEST)
...
Subject: [PATCH v2 2/3] mtd: spi-nor: intel-spi: Convert to SPI MEM
Date:   Thu,  7 Oct 2021 14:21:31 +0300
Message-Id: <20211007112132.30934-3-mika.westerberg@linux.intel.com>
...
index 83e352b0c8f9..5fe26de43537 100644
--- a/drivers/spi/Kconfig
+++ b/drivers/spi/Kconfig
@@ -406,6 +406,45 @@ config SPI_IMX
 	help
...
index f35597cbea0c..d7247616338e 100644
...
+	struct spi_controller *master;
 	...
 	size_t pr_num;
 	bool locked;
@@ -199,9 +197,6 @@ static void intel_spi_dump_regs(struct intel_spi *ispi)
...
@@ -419,7 +414,6 @@ static int intel_spi_init(struct intel_spi *ispi)
 	}
...
@@ -553,10 +547,9 @@ static int intel_spi_sw_cycle(struct intel_spi *ispi, u8 opcode, size_t len,
 	return 0;
 }
...
@@ -574,10 +567,9 @@ static int intel_spi_read_reg(struct spi_nor *nor, u8 opcode, u8 *buf,
...
-	struct intel_spi *ispi = nor->priv;
 	...
 	/*
@@ -632,10 +624,9 @@ static int intel_spi_write_reg(struct spi_nor *nor, u8 opcode, const u8 *buf,
...
-	struct intel_spi *ispi = nor->priv;
 	...
 	u32 val, status;
 	ssize_t ret;
@@ -647,16 +638,6 @@ static ssize_t intel_spi_read(struct spi_nor *nor, loff_t from, size_t len,
...
@@ -685,8 +666,7 @@ static ssize_t intel_spi_read(struct spi_nor *nor, loff_t from, size_t len,
 			ret = -EACCES;
...
@@ -703,10 +683,9 @@ static ssize_t intel_spi_read(struct spi_nor *nor, loff_t from, size_t len,
 	return retlen;
 }
...
-	struct intel_spi *ispi = nor->priv;
 	...
 	u32 val, status;
 	ssize_t ret;
@@ -752,8 +731,7 @@ static ssize_t intel_spi_write(struct spi_nor *nor, loff_t to, size_t len,
 			ret = -EACCES;
...
@@ -766,68 +744,148 @@ static ssize_t intel_spi_write(struct spi_nor *nor, loff_t to, size_t len,
 	return retlen;
 }
...
+
 ...
 {
@@ -896,70 +954,74 @@ static void intel_spi_fill_partition(struct intel_spi *ispi,
 	}
 }
