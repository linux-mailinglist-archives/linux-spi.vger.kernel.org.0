...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 315C042BF23
	for <lists+linux-spi@lfdr.de>; Wed, 13 Oct 2021 13:44:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229653AbhJMLqd (ORCPT <rfc822;lists+linux-spi@lfdr.de>);
        Wed, 13 Oct 2021 07:46:33 -0400
Received: from mga12.intel.com ([192.55.52.136]:55506 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S229571AbhJMLqd (ORCPT <rfc822;linux-spi@vger.kernel.org>);
        Wed, 13 Oct 2021 07:46:33 -0400
X-IronPort-AV: E=McAfee;i="6200,9189,10135"; a="207522318"
X-IronPort-AV: E=Sophos;i="5.85,370,1624345200"; 
   d="scan'208";a="207522318"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 Oct 2021 04:44:29 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.85,370,1624345200"; 
   d="scan'208";a="491422939"
Received: from black.fi.intel.com ([10.237.72.28])
  by orsmga008.jf.intel.com with ESMTP; 13 Oct 2021 04:44:25 -0700
Received: by black.fi.intel.com (Postfix, from userid 1001)
        id 30194367; Wed, 13 Oct 2021 14:44:33 +0300 (EEST)
...
Subject: [PATCH v3 2/3] mtd: spi-nor: intel-spi: Convert to SPI MEM
Date:   Wed, 13 Oct 2021 14:44:31 +0300
Message-Id: <20211013114432.31352-3-mika.westerberg@linux.intel.com>
...
index f35597cbea0c..6ce981637ba6 100644
...
@@ -766,68 +744,160 @@ static ssize_t intel_spi_write(struct spi_nor *nor, loff_t to, size_t len,
 	return retlen;
 }
...
+
 ...
 {
@@ -896,70 +966,74 @@ static void intel_spi_fill_partition(struct intel_spi *ispi,
 	}
 }
